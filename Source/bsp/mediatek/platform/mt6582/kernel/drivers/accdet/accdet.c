...
extern void accdet_exteint_func(void); 
#endif
/* lenovo-sw zhouwl, 2013-07-10, compatible accdet interrupt */
#if 0
...
/* lenovo-sw zhouwl, 2013-07-10, compatible accdet interrupt */
#ifdef LENOVO_COMPATIBLE_DVT_EARPHONE
static void accdet_exteint_set_polarity_pre(void)
{
	mt_eint_set_polarity(CUST_EINT_CHR_STAT_NUM, 1);
}

static void accdet_exteint_set_polarity_next(void)
{
	mt_eint_set_polarity(CUST_EINT_CHR_STAT_NUM, 0);
}


void accdet_exteint_unmask(void)
{
#ifdef ACCDET_EINT
...
void accdet_exteint_set_hw_debounce(void)
{
#ifdef ACCDET_EINT
	mt_eint_set_hw_debounce(CUST_EINT_CHR_STAT_NUM, CUST_EINT_CHR_STAT_DEBOUNCE_CN);
#endif
}

void accdet_exteint_set_hw_cust_debounce(void)
{
#ifdef ACCDET_EINT
	mt_eint_set_hw_debounce(CUST_EINT_CHR_STAT_NUM, CUST_EINT_CHR_STAT_DEBOUNCE_CN);
#endif
...
void accdet_exteint_set_sens(void)
{
}

void accdet_exteint_set(void)
{
#ifdef ACCDET_EINT
    mt_set_gpio_mode(GPIO_EINT_CHG_STAT_PIN, GPIO_EINT_CHG_STAT_PIN_M_EINT);
    mt_set_gpio_dir(GPIO_EINT_CHG_STAT_PIN, GPIO_DIR_IN);
    mt_set_gpio_pull_enable(GPIO_EINT_CHG_STAT_PIN, GPIO_PULL_DISABLE); //To disable GPIO PULL.
	
   // accdet_eint_set_sens();
    accdet_exteint_set_hw_debounce();
#endif
	
}

void accdet_exteint_registration(void)
{
#ifdef ACCDET_EINT
	mt_eint_registration(CUST_EINT_CHR_STAT_NUM, CUST_EINT_CHR_STAT_TYPE, accdet_exteint_func, 0);
	//ACCDET_DEBUG("[Accdet]accdet set EINT finished, accdet_eint_num=%d, accdet_eint_polarity=%d\n", CUST_EINT_CHR_STAT_NUM, CUST_EINT_CHR_STAT_TYPE);
#endif
}

void accdet_exteint_polarity_reverse_plugout(void)
{	
#ifdef ACCDET_EINT
	if (CUST_EINT_CHR_STAT_TYPE == CUST_EINTF_TRIGGER_HIGH){
		accdet_exteint_set_polarity_pre();
	}else{
		accdet_exteint_set_polarity_next();
	}
	accdet_exteint_set_hw_debounce();
#endif
}

void accdet_exteint_polarity_reverse_plugin(void)
{
#ifdef ACCDET_EINT
	if (CUST_EINT_CHR_STAT_TYPE == CUST_EINTF_TRIGGER_HIGH){
		accdet_exteint_set_polarity_next();
	...
	//ACCDET_DEBUG("[Accdet]EINT func :plug-in---------------------\n");
	/* update the eint status */
    accdet_exteint_set_hw_cust_debounce();
#endif
}
#endif
/* lenovo-sw zhouwl, 2013-07-10, compatible accdet interrupt */
