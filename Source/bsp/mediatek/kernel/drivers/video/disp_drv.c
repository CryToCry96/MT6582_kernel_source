...
/* lenovo-sw zhaoxp3 2013.08.09 begin */
int hw_id = 0;
/* lenovo-sw zhaoxp3 2013.08.09 end */
...
/*lenovo-sw zhaoxp3 2013.08.09 begin*/
       p = strstr(cmdline, "mod_id=");
       if(p == NULL){
               hw_id= 0;
               printk("[FB driver]can not get mod from lk \n");
       }
       else{
               p += 7;
               hw_id= simple_strtol(p, NULL, 10);
       }
       printk("[FB driver] lcm mod = %d\n", hw_id);
